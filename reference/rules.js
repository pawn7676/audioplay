/*  audioplay-web — rules.js
 *  Read the app.js header first: it carries the project
 *  story, the hard constraints, and the file map. This
 *  file is section 13 of the userscript, ported verbatim.
 *
 *  FROZEN. Verified by perft: startpos depth 4 = 197281,
 *  Kiwipete depth 3 = 97862. Re-run BOTH after ANY edit
 *  here. Being its own file now, the test needs no slicing:
 *  node loads this file directly (it has no browser
 *  dependencies) and calls makeRules().
 *
 *  FAIR PLAY, restated where it binds: this file may only
