 ...
 */
  ...
  function savePanels() {
    ...
    try {
      ...
      log("UI", "panels saved " + JSON.stringify(state));
    } catch (e) {
  ...
  function restorePanels() {
    ...
    var found = panelDetails();
    log("UI", "panels found " + found.length + ", saved state " +
        (state ? JSON.stringify(state) : "none"));
    Array.prototype.forEach.call(found, function (d) {
